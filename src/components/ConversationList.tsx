...
export function ConversationList({
  ...
  return (
    <div className="flex flex-col h-full" style={{ backgroundColor: "var(--canvas)" }}>
      {/* Header */}
      <div className="px-3 py-2.5 border-b flex items-center justify-between" style={{ borderColor: "var(--hairline)" }}>
